...
# so Python can find our local modules
...
from database.scan_proposal import ProposalScanner
from database import create_firebase_client, close_firebase_client
